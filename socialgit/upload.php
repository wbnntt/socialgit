...
***********************************************************/
	...
	// wb changed the path from Demo to event-webapp/social
		$uploaddir = $_SERVER['DOCUMENT_ROOT'].'/event-social/social/assets/images/profile_pics';
	//Set File name
...
<div class="main_column column">
	...
	<div id="formExample" style="margin-top:80px; margin-left:10px;">

	    <p><b> <?=$msg?> </b></p>

	    <form action="upload.php" method="post"  enctype="multipart/form-data">
	        Upload Your New Photo<br /><br />
